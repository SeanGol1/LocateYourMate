            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div id="SessionsList">
                        ...
                        <asp:ListBox ID="lbxSessionlist" runat="server" OnSelectedIndexChanged="lbxSessionlist_SelectedIndexChanged" DataSourceID="SqlDataSource1" DataTextField="sessionCode" DataValueField="sessionCode" AppendDataBoundItems="True" AutoPostBack="True" ViewStateMode="Enabled"></asp:ListBox>
